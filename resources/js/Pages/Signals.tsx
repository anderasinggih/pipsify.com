...
import { LineChart, Lock, TrendingUp, TrendingDown, Target, AlertTriangle } from 'lucide-react';
            ...
            header={
                <div>
                    <h2 className="text-base md:text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
                        <LineChart className="text-primary w-5 h-5 md:w-6 md:h-6" />
                        AI Trading Signals
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {signals.length === 0 && (
                        <div className="col-span-full py-12 text-center border-2 border-dashed border-border rounded-3xl">
                            <LineChart className="w-12 h-12 text-muted-foreground/30 mx-auto mb-4" />
